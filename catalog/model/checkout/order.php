...
class ModelCheckoutOrder extends Model {
	...
	public function getOrderProducts($order_id) {
		...
		$query = $this->db->query(" SELECT o.*,(SELECT os.name FROM `" . DB_PREFIX . "order_status` os WHERE os.order_status_id = o.order_status_id AND os.language_id = o.language_id) AS order_status,op.* FROM `" . DB_PREFIX . "order` o  inner join " . DB_PREFIX . "order_product op on op.order_id = o.order_id WHERE o.order_id = '" . (int)$order_id . "'");
	...
	public function getOrderList($user_id) {
		...
		$order_query = $this->db->query("SELECT *, (SELECT os.name FROM `" . DB_PREFIX . "order_status` os WHERE os.order_status_id = o.order_status_id AND os.language_id = o.language_id) AS order_status FROM `" . DB_PREFIX . "order` o WHERE o.customer_id = '" . (int)$user_id . "' ORDER BY o.date_added DESC");
