...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['reg_otp'])) {
			$data['reg_otp'] = $this->request->post['reg_otp'];
		} else {
			$data['reg_otp'] = '';
		}
	...
	private function validate() {
		...
		if ($this->request->post['otp'] != $this->request->post['reg_otp']) {
			$this->error['otp'] = $this->language->get('error_otp');
		}
	...
	public function sendotp() {
		...
		$numbers = $this->request->post['mobile']; // A single number or a comma-seperated list of numbers
		$message = $message;
