<?php
// Text
$_['text_title']				= 'חשבון קלרנה - שלם מ %s/חודש';
...
$_['text_information']			= 'נתוני חשבון קלרנה';
$_['text_additional']			= 'חשבון קלרנה דורש מידע  נוסף לפני שהם יוכלו לבצע את ההזמנה שלך.';
$_['text_male']					= 'זכר';
$_['text_female']				= 'נקבה';
$_['text_year']					= 'שנה';
$_['text_month']				= 'חודש';
$_['text_day']					= 'יום';
$_['text_payment_option']		= 'אפשרויות תשלום';
$_['text_single_payment']		= 'תשלום בודד';
$_['text_monthly_payment']		= '%s - %s כל חודש';
...
$_['error_address_match']		= 'כתובות  גביה ומשלוח חייבים להיות תואמים אם ברצונך להשתמש בחשבון קלרנה';
