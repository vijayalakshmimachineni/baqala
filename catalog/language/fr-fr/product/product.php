...
$_['text_reviews']             = '%s critiques';
$_['text_write']               = 'Écrire une critique';
$_['text_login']               = 'S\'il vous plaît <a href="%s"> connexion </a> ou <a href="%s"> S\'enregistrer </a> de revoir';
$_['text_no_reviews']          = 'Il n\'y a aucune critique sur ce produit.';
$_['text_note']                = '<span class="text-danger"> Note: </span> Le code HTML n\'est pas la traduction!';
...
$_['error_rating']             = 'Attention: Veuillez sélectionner une note pour l\'évaluation!';