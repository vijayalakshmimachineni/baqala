<?php
class ControllerCatalogManapprovals extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('catalog/manapprovals');

		$this->document->setTitle($this->language->get('heading_title'));

		$this->load->model('catalog/manapprovals');
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_manapprovals->editManufacturer($this->request->get['manufacturer_id'], $this->request->post);
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/manapprovals', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/manapprovals/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/manapprovals/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$manufacturer_total = $this->model_catalog_manapprovals->getTotalManufacturers();

		$results = $this->model_catalog_manapprovals->getManufacturers($filter_data);
		...
		foreach ($results as $result) {
			$data['manufacturers'][] = array(
				...
				'edit'            => $this->url->link('catalog/manapprovals/edit', 'user_token=' . $this->session->data['user_token'] . '&manufacturer_id=' . $result['manufacturer_id'] . $url, true)
			);
		}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['manufacturer_id'])) {
			$data['action'] = $this->url->link('catalog/manapprovals/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/manapprovals/edit', 'user_token=' . $this->session->data['user_token'] . '&manufacturer_id=' . $this->request->get['manufacturer_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/manapprovals', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['manufacturer_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$manufacturer_info = $this->model_catalog_manapprovals->getManufacturer($this->request->get['manufacturer_id']);
		}
		...
		if (isset($this->request->post['manufacturer_store'])) {
			...
			$data['manufacturer_store'] = $this->model_catalog_manapprovals->getManufacturerStores($this->request->get['manufacturer_id']);
		} else {
		...
		if (isset($this->request->post['manufacturer_seo_url'])) {
			...
			$data['manufacturer_seo_url'] = $this->model_catalog_manapprovals->getManufacturerSeoUrls($this->request->get['manufacturer_id']);
		} else {
