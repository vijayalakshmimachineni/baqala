...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/catapprovals')) {		
				$approvals[] = array(
					'name'	   => $this->language->get('text_catapprovals'),
					'href'     => $this->url->link('catalog/catapprovals', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			if ($this->user->hasPermission('access', 'catalog/proapprovals')) {		
				$approvals[] = array(
					'name'	   => $this->language->get('text_proapprovals'),
					'href'     => $this->url->link('catalog/proapprovals', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			if ($this->user->hasPermission('access', 'catalog/manapprovals')) {		
				$approvals[] = array(
					'name'	   => $this->language->get('text_manapprovals'),
					'href'     => $this->url->link('catalog/manapprovals', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			if ($approvals) {
				$data['menus'][] = array(
					'id'       => 'menu-approvals',
					'icon'	   => 'fa-tags', 
					'name'	   => $this->language->get('text_approvals'),
					'href'     => '',
					'children' => $approvals
				);		
			}
			...
			if ($this->user->hasPermission('access', 'sale/orderstatus')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_orderstatus'),
					'href'     => $this->url->link('sale/orderstatus', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
