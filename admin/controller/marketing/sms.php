...
class ControllerMarketingSms extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketing/sms', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['cancel'] = $this->url->link('marketing/sms', 'user_token=' . $this->session->data['user_token'], true);
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if (!$json) {
				...
				if ($emails) {
					...
					$json['error']['telephone'] = $this->language->get('error_email');
				}
			}
		}
