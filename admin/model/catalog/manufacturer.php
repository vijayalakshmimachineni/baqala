...
class ModelCatalogManufacturer extends Model {
	...
	public function getManufacturers($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "manufacturer WHERE status IN(0)";
		// $sql = "SELECT * FROM " . DB_PREFIX . "manufacturer WHERE status IN(1,2)";
	...
	public function getTotalManufacturers() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "manufacturer WHERE status IN (1,2)");
