...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer,o.payment_city as city, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.delivery_date, o.payment_method FROM `" . DB_PREFIX . "order` o";
		...
		if (!empty($data['filter_city'])) {
			$sql .= " AND o.payment_city LIKE '%" . $this->db->escape($data['filter_city']) . "%'";
		}
	...
	public function getTotalOrders($data = array()) {
		...
		if (!empty($data['filter_payment_method'])) {
			$sql .= " AND payment_code = '" . $data['filter_payment_method'] . "'";
		}
	...
	public function getPaymentMethods() {
		$sql = "SELECT type, code FROM " . DB_PREFIX . "extension WHERE type = 'payment'";
