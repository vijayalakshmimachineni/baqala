...
$_['text_ip_message']				 = 'Musíte před uvedením do provozu poskytnout adresu serveru IP správci účtu Realex';
...
$_['entry_card_data_status']		 = 'Zaznamenávání informací o kartě';
$_['entry_3d']						 = 'Povolit zabezpečení 3D';
$_['entry_liability_shift']			 = 'Přijměte scénáře pro změnu ručení';
...
$_['help_liability']				 = 'Přijetí odpovědnosti znamená, že i nadále přijímáte platby, pokud uživatel nezajistí zabezpečení 3D.';
$_['help_card_data_status']			 = 'Záznamy mají čtyři číslice, vyprší platnost, název, typ a vydávají bankovní informace';
