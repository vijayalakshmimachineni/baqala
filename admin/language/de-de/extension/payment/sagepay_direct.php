...
$_['text_success']			  = 'Erfolg: Sie haben die SagePay-Kontodetails! geändert';
$_['text_edit']               = 'Bearbeiten Sie SagePay Direct';
...
$_['text_test']				  = 'Prüfung';
$_['text_live']				  = 'Leben';
$_['text_defered']			  = 'Abgelehnt';
$_['text_authenticate']		  = 'Authentifizieren';
...
$_['entry_card']			  = 'Speicherkarten';
$_['entry_cron_job_token']	  = 'Geheimes Token';
$_['entry_cron_job_url']	  = 'Cron Job\'s URL';
$_['entry_last_cron_job_run'] = 'Die Laufzeit des letzten Cronjobs:';
...
$_['help_transaction']		  = 'Die Transaktionsmethode MUSS auf Zahlung festgelegt werden, um Abonnementzahlungen zu ermöglichen';
$_['help_cron_job_token']	  = 'Machen Sie das lang und schwer zu erraten';
$_['help_cron_job_url']		  = 'Legen Sie einen Cron-Job fest, um diese URL aufzurufen';
...
// Error
$_['error_permission']		  = 'Warnung: Sie sind nicht berechtigt, die Zahlung SagePay! zu ändern';
$_['error_vendor']			  = 'Anbieter-ID erforderlich!';
