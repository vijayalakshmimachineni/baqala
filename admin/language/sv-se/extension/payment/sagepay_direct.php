...
$_['text_edit']               = 'Redigera SagePay Direct';
...
$_['text_authenticate']		  = 'autentisera';
...
$_['entry_cron_job_token']	  = 'Hemlig Token';
$_['entry_cron_job_url']	  = 'Cron Job \'s URL';
$_['entry_last_cron_job_run'] = 'Senaste cron jobbets körtid:';
...
$_['help_transaction']		  = 'Transaktionsmetod MÅSTE ställas in på Betalning för att tillåta abonnemangsbetalningar';
...
// Error
$_['error_permission']		  = 'Varning: Du har inte behörighet att ändra betalning SagePay!';
$_['error_vendor']			  = 'Leverantörs-ID Required!';
