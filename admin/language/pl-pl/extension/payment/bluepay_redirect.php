<?php
// Heading
$_['heading_title']			 = 'Przekierowanie BluePay (wymaga SSL)';

// Text
$_['text_extension']		 = 'Rozszerzenia';
$_['text_success']			 = 'Sukces: Zmodyfikowano szczegóły konta Przekierowania BluePay!';
$_['text_edit']              = 'Edytuj przekierowanie BluePay (wymaga SSL)';
...
$_['text_authenticate']		 = 'Autoryzować';
$_['text_release_ok']		 = 'Wydanie się powiodło';
$_['text_release_ok_order']	 = 'Wydanie się powiodło';
...
// Entry
$_['entry_vendor']			 = 'ID konta';
$_['entry_secret_key']		 = 'Sekretny klucz';
$_['entry_test']			 = 'Tryb transakcji';
...
$_['help_transaction']		 = 'Sprzedaż obciąży klienta natychmiast. Autoryzacja wstrzyma fundusze na przyszłe zdobycie.';
$_['help_cron_job_token']	 = 'Uczyń to długo i trudno odgadnąć';
$_['help_cron_job_url']		 = 'Ustaw zadanie cron, aby wywołać ten adres URL';
...
// Error
$_['error_permission']		 = 'Ostrzeżenie: nie masz uprawnień do modyfikowania płatności BluePay!';
$_['error_account_id']		 = 'Wymagany identyfikator konta!';
$_['error_secret_key']		 = 'Wymagany klucz tajny!';