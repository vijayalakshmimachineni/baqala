...
// Entry
$_['entry_merchant']		= 'ID de comerciante de Klarna';
...
// Help
$_['help_merchant']			= '(estore id) para usar para el servicio de Klarna (provisto por Klarna).';
...
// Error
$_['error_permission']		= 'Advertencia: no tiene permiso para modificar el pago Klarna Part Payment!';
$_['error_pclass']			= 'No se pudo recuperar pClass para %s. Código de error: %s; Mensaje de error: %s';
$_['error_curl']			= 'Curl Error - Código: %d; Mensaje: %s';
$_['error_log']				= 'Hubo errores actualizando el módulo. Por favor revise el archivo de registro.';