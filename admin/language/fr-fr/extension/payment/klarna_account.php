...
// Error
$_['error_permission']		= 'Attention: Vous n\'avez pas la permission de modifier le paiement Klarna Part Payment!';
$_['error_pclass']			= 'Impossible de récupérer pClass pour %s. Code d\'erreur: %s; Message d\'erreur: %s';
$_['error_curl']			= 'Erreur de boucle - Code: %d; Message: %s';
$_['error_log']				= 'Des erreurs se sont produites lors de la mise à jour du module. Veuillez vérifier le fichier journal.';