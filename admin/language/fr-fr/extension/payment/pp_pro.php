...
$_['text_success']		 = 'Succès: Vous avez modifié les détails du compte PayPal Site Payment Pro Checkout!';
$_['text_edit']          = 'Modifier PayPal Pro';
...
// Help
$_['help_test']			 = 'Utilisez le serveur de passerelle en direct ou testing (sandbox) pour traiter les transactions?';
$_['help_total']		 = 'Le total de la commande que l\'ordre doit atteindre avant que cette méthode de paiement ne devienne active';

// Error
$_['error_permission']	 = 'Attention: Vous n\'avez pas la permission de modifier le paiement PayPal Website Payment Pro Checkout!';
